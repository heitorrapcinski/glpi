...
/**
 * OLA aggregate — Operational Level Agreement (internal SLA for teams).
 * Same structure as Sla but scoped to internal teams.
...
public class Ola {
    ...
    public Ola(String id, String name, String entityId, SlaType type,
