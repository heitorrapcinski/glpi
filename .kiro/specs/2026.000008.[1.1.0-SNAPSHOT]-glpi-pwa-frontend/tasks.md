...
- [ ] 1. Scaffold project structure, tooling, and core configuration
...
- [ ] 2. Implement design token system, theme engine, and CSS foundation
  - [ ] 2.1 Create base design tokens and palette CSS files
  ...
  - [ ] 2.2 Implement theme engine runtime switching
...
- [ ] 3. Implement HTTP client, auth store, and token management
  - [ ] 3.1 Create Axios HTTP client with interceptors
  ...
  - [ ] 3.2 Implement auth store with Zustand
...
- [ ] 4. Implement utility functions (status, priority, pagination, formatters, validators)
  - [ ] 4.1 Create status and priority utility modules
  ...
  - [ ] 4.2 Create pagination and search utility modules
  ...
  - [ ] 4.3 Create formatters and validators utility modules
